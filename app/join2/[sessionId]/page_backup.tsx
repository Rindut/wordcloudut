...
export default function Join2Page() {
  ...
  useEffect(() => {
    if (cooldownSeconds <= 0) {
      // When cooldown ends, reset attempts to maxEntriesPerUser
      if (attemptsLeft !== maxEntriesPerUser) {
        setAttemptsLeft(maxEntriesPerUser);
      }
      return;
    }
  ...
  }, [cooldownSeconds, attemptsLeft, maxEntriesPerUser]);
